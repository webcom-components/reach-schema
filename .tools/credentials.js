...
const path = `${__dirname}/../.account`;
let fromFile = loadConf(`${path}.json`) || loadConf(`${path}.yml`) || loadConf(`${path}.yaml`);
...
module.exports = credentials;//mapValues(credentials, v => v ? `'${v}'` : null);
